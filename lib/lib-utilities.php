 ...
 */
function site_logo() {
	$logo = '<svg class="inline-block transition size-8 hi-mini hi-cube-transparent" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 20 20" fill="currentColor" aria-hidden="true">
